...
- [ ] **Если добавлялись/удалялись изображения** — прогнан `npm run build:images` (обновляет `assets/img/build/image-dimensions.json`; шаблон `picture.twig` гейтит `<source>` через этот манифест, ADR-0006)
