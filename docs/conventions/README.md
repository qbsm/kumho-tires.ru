...
- [content-consistency.md](content-consistency.md) — актуальность контента: источники правды для цифр, синхронность текста и микроразметки, проверка npm run check:content
