...
use App\Middleware\ErrorLogMiddleware;
...
use App\Support\PhpErrorLogger;
...
return static function (App $app): void {
    ...
    PhpErrorLogger::register($container->get(LoggerInterface::class));
    ...
    // Добавляется последним, поэтому оборачивает весь стек и видит финальный статус
    // любого ответа — включая 404 от роутинга и 500 после обработчиков ошибок.
    $app->add($container->get(ErrorLogMiddleware::class));
};
